...
class Bird extends Animal implements Flyable, Runable{
  ...
  @override
  String fly() => '$name is flying at $flySpeed km/h, ih he run it just $runSpeed km/h';

  String featherColor = '';

  Bird(super.name, super.age, this.featherColor, this.flySpeed, this.runSpeed);
...
void main(){
  ...
  Bird eagle = Bird('birdy', 2, 'black', 300, 30);
